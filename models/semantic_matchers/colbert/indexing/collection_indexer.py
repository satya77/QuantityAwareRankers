...
from models.semantic_matchers.colbert.infra.config.config import ColBERTConfig

import models.semantic_matchers.colbert.utils.distributed as distributed
...
from models.semantic_matchers.colbert.data.collection import Collection

from models.semantic_matchers.colbert.indexing.index_saver import IndexSaver
from models.semantic_matchers.colbert.indexing.utils import optimize_ivf

from models.semantic_matchers.colbert.indexing.codecs.residual import ResidualCodec
import torch

from models.semantic_matchers.colbert.infra.run import Run
from models.semantic_matchers.colbert.utils.utils import print_message, batch
...
def encode(config, collection, shared_lists, shared_queues,data_type):
    encoder = CollectionIndexer(config=config, collection=collection,data_type=data_type)
...
class CollectionIndexer():
    ...
    '''
    def __init__(self, config: ColBERTConfig, collection,data_type):
        self.config = config
        ...
        print("len collection is,",str(len(self.collection)))
